...
function guessType(message = '') {
  ...
  if (m.includes('booking') || m.includes('approved') || m.includes('rejected') || m.includes('cancel')) return 'BOOKING'
  if (m.includes('ticket') || m.includes('resolved') || m.includes('closed') || m.includes('assigned')) return 'TICKET'
              ...
              {filtered.length === 0 && (
                <li className="flex flex-col items-center gap-2 px-4 py-10 text-center">
                  ...
                  <p className="text-sm text-slate-500">
                    {tab === 'ALL' ? 'All caught up!' : `No ${tab.toLowerCase()} notifications`}
                  </p>
                </li>
              )}
                ...
                {filtered.map((n) => {
                  ...
                  return (
                    <motion.li
                      ...
                      className={'group px-4 py-3 ' + (n.read ? 'opacity-60' : 'bg-violet-50/30')}
                    >
