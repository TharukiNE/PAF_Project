  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">Manage user roles (USER / TECHNICIAN / ADMIN).</p>
      </div>
        ...
        {loading ? (
          ...
          <div className="overflow-hidden rounded-lg border border-slate-100">
            ...
            <div className="divide-y divide-slate-100">
              {users.length === 0 && (
                <div className="px-4 py-12 text-center text-sm text-slate-500">No users found.</div>
              )}
              ...
              {users.map((u) => {
                ...
                const disabled = !canEdit || isSelf(u.id) || updatingId === u.id
                ...
                return (
                  <div key={u.id} className="grid grid-cols-12 items-center gap-3 px-4 py-4">
                    ...
                    <div className="col-span-2">
                      <span className="badge ring-1 bg-indigo-50 text-indigo-700 ring-indigo-100">
                        {currentRole}
                      </span>
                    </div>
